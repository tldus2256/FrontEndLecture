...
// 1. 현재 날짜/시간
let today = new Date();
console.log(today);                             // 2024-01-08T04:48:47.744Z , Timezone 미반영
console.log(today.toISOString());               // 2024-01-08T04:48:47.744Z
console.log(today.toLocaleString());            // 2024. 1. 8. 오후 1:48:47, Timezone 반영
...
let tomoroow = new Date('Jan 9 2024');
